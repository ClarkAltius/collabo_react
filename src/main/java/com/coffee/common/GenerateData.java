...
public class GenerateData {
    ...
    public List<String> getImageFileNames(){
        ...
        //모든 파일 이름을 소문자로 변경 후 확장자와 비교 후 조건에 부합하면 컬렉션에 추가
        if (fileList != null) {
